...
using DocxSkill.Core.OpenXml;
using DocxSkill.Core.Typography;
using WpPageSize = DocumentFormat.OpenXml.Wordprocessing.PageSize;

namespace DocxSkill.Core.Samples;
...
public static class DocumentCreationSamples
{
    ...
    public static void SetDocumentProperties(WordprocessingDocument doc)
    {
        ...
        doc.PackageProperties.Creator = "Agent Skills";          // Author
        ...
        {
            Company = new Company("Agent Skills Registry"),
            Application = new Application("DocxSkill"),
