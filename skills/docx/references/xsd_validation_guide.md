...
$CLI validate --input input.docx --xsd assets/xsd/wml-subset.xsd

# Validate against business rules (REQUIRED for Scenario C gate-check)
$CLI validate --input input.docx --xsd assets/xsd/business-rules.xsd

# Validate against both
$CLI validate --input input.docx --xsd assets/xsd/wml-subset.xsd --xsd assets/xsd/business-rules.xsd
```
